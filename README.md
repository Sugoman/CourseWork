...
| 📝 **Упражнения** | MCQ, fill-in-the-blank, исправление ошибок — генерируются AI |
...
| 📖 **Грамматика** | Интерактивное дерево навыков с SM-2, AI-упражнениями и due-ревью |
...
│   │       ├── GrammarPractice  # Сессия практики грамматического правила
...
| **AI** | Ingat.AI микросервис (ASP.NET Core), LLM-интеграция, генерация упражнений |
...
- **Интерактивная грамматика:** дерево навыков, AI-упражнения, SM-2, прогресс
