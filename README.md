...
![Tests](https://img.shields.io/badge/tests-223%20passed-success?style=flat-square)
...
│   │   ├── Shared/             # CommentsSection и другие компоненты
│   │   └── Pages/              # 15 страниц:
│   │       ├── Home             # Landing page
...
│   │       ├── Training         # Тренировки (Flashcard, MCQ, Typing)
...
│   │   ├── StatisticsController # Статистика и достижения
...
├── 🧪 LearningAPI.Tests/       # Unit-тесты (223 тестов)
...
- Тренировки (Flashcard, MCQ, Typing), статистика, AI-генерация словарей
