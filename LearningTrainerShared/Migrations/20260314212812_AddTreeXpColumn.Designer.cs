...
namespace LearningTrainerShared.Migrations
{
    ...
    [Migration("20260314212812_AddTreeXpColumn")]
    partial class AddTreeXpColumn
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LearningTrainerShared.Models.KnowledgeTree", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("TotalWordsContributed")
                        .HasColumnType("int");

                    b.Property<long>("TotalXpContributed")
                        .HasColumnType("bigint");

                    b.Property<int>("TreeSkinId")
                        .HasColumnType("int");

                    b.Property<long>("TreeXp")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("TreeSkinId");

                    b.HasIndex("UserId")
                        .IsUnique();

                    b.ToTable("KnowledgeTrees");
                });
            ...
            modelBuilder.Entity("LearningTrainerShared.Models.TreeSkin", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LearningTrainerShared.Models.KnowledgeTree", b =>
                {
                    b.HasOne("LearningTrainerShared.Models.TreeSkin", "TreeSkin")
                        .WithMany()
                        .HasForeignKey("TreeSkinId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
